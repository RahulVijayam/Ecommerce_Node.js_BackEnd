...
const addFirm  = async(req,res)=>{
 try{
    ...
    if(vendor.firm.length>0){   return res.status(400).json({message:"Vendor can have only one firm"})  }
    ...
    return res.status(200).json({success:"Firm Added Succesfully",firmId})
 }
 catch(error){
    //console.log(error)
